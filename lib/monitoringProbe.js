...
function buildDataObject(results, callback) {
    ...
    if (configGlobal.fullMemoryInstrumentation) {
        data.memory = currentMemoryStats;
        data.lastLeak = lastLeakStats;
...
function setMemoryData(stats) {
    currentMemoryStats = stats;
}

function setLastLeak(stats) {
    currentMemoryStats = stats;
}

exports.setLastLeak = setLastLeak;
exports.setMemoryData = setMemoryData;
