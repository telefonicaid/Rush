...
function startMonitorization() {
    ...
    monitorInterval = setInterval(monitor, configGlobal.probeInterval);
}

function stopMonitorization() {
    logger.info('Stopping monitoring probe', { op: 'STOP_MONITORING_PROBE'});
    clearInterval(monitorInterval);
}

exports.start = startMonitorization;
exports.stop = stopMonitorization;
