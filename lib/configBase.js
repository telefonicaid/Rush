...
/*
 ...
 You should have received a copy of the GNU Affero General Public License along with RUSH. If not, seehttp://www.gnu.org/licenses/.
...
/**
 * Activates the in-process memory instrumentation. WARNING: this is NOT meant for
 * production use; the performance will be lowered significantly.
 */
exports.fullMemoryInstrumentation = true;

/**
 * Activates the Heap Difference timer. This timer will take a snapshot of the heap
 * with the periodicity indicated, writing a file with the results for each difference.
 * WARNING: this is NOT meant for production use; the performance will be lowered significantly.
 */
exports.activateHeapDiff = true;
exports.periodHeapDiff = 60 * 1000;
