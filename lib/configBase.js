...
// DIRTY AND QUICK FOR OPENSTACK TRY

var myfs = require('fs');
if(myfs.existsSync('/root/ipredis.txt')) {
  var ipredis = myfs.readFileSync('/root/ipredis.txt').toString().split("\n")[0];
  exports.queue.redisHost = ipredis;
}
