...
/*
 States the max memory that will be used at Redis before STOP pushing new tasks
 Usually a percentage of Redis Total memory (It includes Queue + Persistence)
 it will be used in order to limit the size of the task queue.
 It do not avoid to fulfill the whole Redis Mem (just make it less probable)
 */
 ...
 */
exports.consumer.trustAllServers = false; // true, false
