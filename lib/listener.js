...
function start(done) {
  ...
  function notImplemented(req, res) {
    ...
    var response = apiErrorsParser.parseError({ type: G.NOT_IMPLEMENTED });
    res.send(response.statusCode, response.data);

    var reqLog = { method: req.method, url: req.url };
    logger.info('Not Implemented', reqLog);
  }
